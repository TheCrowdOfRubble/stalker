from typing import Union, Iterator, Callable, List, Any

from scrapy.http import Request, Response
from scrapy.loader.processors import MapCompose, TakeFirst

import items
from items.processors import remove_invisible_character, get_dict_from_profile, EmptyTo
from parse import FetchItemsAndNext
